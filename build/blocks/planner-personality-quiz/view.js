...
/*!*****************************************************!*\
  !*** ./src/blocks/planner-personality-quiz/view.js ***!
  \*****************************************************/
...
function renderForm() {
  ...
  const root = (0,react_dom_client__WEBPACK_IMPORTED_MODULE_1__.createRoot)(quizDiv);
  root.render(/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)(QuizRender, {}));
}
function QuizRender() {
  // const quizData = [
  //     {
  ...
  const quizData = [{
    question: '',
    answers: [{
      text: 'Geriausia, kai galiu dieną pradėti peržiūrėjus darbų sąrašą ir detaliai suplanavus darbotvarkę.',
      letter: 'J'
    }, {
      text: 'Pradedant ar jau vykdant projektą, man svarbu užtikrinti, kad rezultatai ir sprendimai atitiktų visų susijusių šalių poreikius.',
      letter: 'F'
    }, {
      text: 'Mane motyvuoja praktinė užduoties nauda ir apčiuopiami darbo rezultatai.',
      letter: 'S'
    }, {
      text: 'Kilus konfliktui darbe, problemą imuosi spręsti tiesiogiai ir visų pirma ieškau logiškiausio varianto.',
      letter: 'T'
    }, {
      text: 'Atėjus idėjai, man geriausia ją pirmiau apmąstyti vienumoje ir tuomet su kitais  pasidalinti raštu.',
      letter: 'I'
    }]
  }
  // {
  ...
  const points = ["100% ne aš", "Nepanašu į mane", "Gaaaal kartais", "Skamba panašiai", "100% AŠ!"];
  const tieBreakerQuestions = [{
    ...
    answers: [{
      text: 'Labiau pasikliauju konkrečiais faktais, ankstesne patirtimi ir žingsnių planu.',
      letter: 'S'
    }, {
      text: 'Pradedu nuo vizijos kūrimo ir ieškau naujų galimybių bei kūrybiškų sprendimų.',
      letter: 'N'
    }]
  }, {
    question: 'Kaip priimi sprendimą dėl komandos nario veiklos?',
    answers: [{
      text: 'Vertinu pagal objektyvius rezultatus ir veiklos efektyvumą.',
      letter: 'T'
    }, {
      text: 'Atsižvelgiu į komandos nario pastangas ir kaip tai paveiks jo motyvaciją bei jausmus.',
      letter: 'F'
    }]
  }, {
    question: 'Kaip tvarkaisi su pasikeitimais projekte?',
    answers: [{
      text: 'Stengiuosi laikytis pirminio plano ir kiek įmanoma išvengti pakeitimų.',
      letter: 'J'
    }, {
      text: 'Lengvai prisitaikau prie pakeitimų ir dažnai randu naujų būdų veiksmingai išspręsti situacijas.',
      letter: 'P'
    }]
  }];
  const [currentQuestion, setCurrentQuestion] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const [currentVariant, setCurrentVariant] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  ...
  const [dichotomy, setDichotomy] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(['', '', '', '']);
  const [tieBreak, setTieBreak] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)([]);
  const [currentTieBreakQuestion, setCurrentTieBreakQuestion] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(0);
  const [showResultContainer, setShowResultContainer] = (0,react__WEBPACK_IMPORTED_MODULE_0__.useState)(false);
  const handleChange = (answerLetter, points, variantIndex) => {
    ...
    setCurrentVariant(prevVariant => variantIndex < currentVariant ? currentVariant : prevVariant + 1 >= quizData[currentQuestion].answers.length ? currentVariant : prevVariant + 1);
  ...
  const activeElementRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(null);
  ...
  return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)(react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.Fragment, {
    children: [quizData[currentQuestion] && quizData[currentQuestion].answers.map((answer, answerIndex) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
      className: `variant ${currentVariant !== answerIndex ? 'inactive' : 'active'}`,
      id: `variant-${answer.letter}`,
      ref: currentVariant !== answerIndex ? activeElementRef : null,
      children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("p", {
        ...
        children: [points.map((point, pointIndex) => {
          ...
          className: "points-pos",
          id: `points-pos-${answer.letter}`
        })]
      })]
    })), tieBreak.length > 0 && tieBreak.map((q, index) => {
      return /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
        id: "tie-break",
        ref: index === currentTieBreakQuestion ? activeElementRef : null,
        children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("p", {
          children: tieBreakerQuestions[q].question
        }), tieBreakerQuestions[q].answers.map((a, idx) => /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsxs)("div", {
          class: "tie-break-control",
          children: [/*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("input", {
            type: "radio",
            name: `radio-${q}`,
            id: `radio-${q}-${a.letter}`,
            ...
            className: "tie-break-lbl",
            htmlFor: `radio-${q}-${a.letter}`,
            children: a.text
          }, idx)]
        }))]
      }, index);
    }), showResultContainer && /*#__PURE__*/(0,react_jsx_runtime__WEBPACK_IMPORTED_MODULE_2__.jsx)("div", {
      children: "rezultatas"
      ...
      className: `send-email-button ${ false ? 0 : 'hidden'}`,
      onClick: sendEmail,
      children: "send email"
    })]
  });
