...
const EnergyFlowComponent = ({ chronotypeData, className = '', title = 'Tinkamiausias laikas užduotims pagal tavo chronotipą*' }) => {
  ...
  return (
    <div className={`energy-flow-component ${className}`}>
      <div className="energy-flow-title">{title}</div>
